...
export declare const CI_VERSION = "1.0.94";
...
export declare const MiniProgramWhiteList: MiniProgramCI.IAnyObject;
export declare const GameWhiteList: MiniProgramCI.IAnyObject;
export declare const TABBAR_ICON_WHITE_LIST: string[];
export declare const DefaultProjectAttr: MiniProgramCI.IProjectAttr;
